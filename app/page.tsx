  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/signup" className="bg-hack-red text-white px-4 py-2 rounded-lg font-bold hover:bg-red-600 transition-colors">
                Sign Up
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center text-white">
            ...
            <div className="flex justify-center space-x-4">
              <Link href="/signup?role=teacher" className="bg-white text-hack-red px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors">
                I'm a Teacher
              </Link>
              <Link href="/signup?role=student" className="bg-hack-dark text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-900 transition-colors">
                I'm a Student
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h2 className="text-4xl font-bold text-center mb-16 text-hack-dark">
      ...
      {/* How It Works */}
      <div className="bg-hack-dark py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-gradient-to-r from-hack-blue to-hack-green py-20">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link href="/signup" className="inline-block bg-white text-hack-dark px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors">
      ...
      {/* Footer */}
      <footer className="bg-hack-dark border-t-4 border-hack-red py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
...
function FeatureCard({ icon, title, description }: { icon: string; title: string; description: string }) {
  return (
    <div className="bg-white border-4 border-hack-dark rounded-xl p-6 hover:shadow-xl transition-shadow">
      <div className="text-5xl mb-4">{icon}</div>
      <h3 className="text-2xl font-bold mb-3 text-hack-dark">{title}</h3>
...
function StepCard({ number, title, description }: { number: string; title: string; description: string }) {
  return (
    <div className="text-center">
      <div className="w-16 h-16 bg-hack-red rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
        {number}
      </div>
